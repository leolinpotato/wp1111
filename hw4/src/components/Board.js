            ...
            <div className='boardWrapper' >
                ...
                <div className="boardContainer">
                    ...
                    {board.map((row, rowIdx) => {
                        return (
                            <div key={rowIdx} id={rowIdx} style={{display: 'flex'}}>
                                {row.map((element, colIdx) => <Cell key={board.length*rowIdx+colIdx} rowIdx={rowIdx} colIdx={colIdx} detail={element} updateFlag={updateFlag} revealCell={revealCell}/>)}
                            </div>
                            )
                        })
                    }
